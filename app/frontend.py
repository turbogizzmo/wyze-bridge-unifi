# Apply spyne compatibility patch FIRST before ANY imports that might use spyne
# This must be done unconditionally in case ONVIF is enabled
try:
    import wyzebridge.spyne_patch
except ImportError:
    pass  # Patch not needed if spyne is not installed
