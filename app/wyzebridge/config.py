...
ONVIF_ENABLE: bool = env_bool("ONVIF_ENABLE", style="bool")
ONVIF_PORT: int = env_bool("ONVIF_PORT", "8080", style="int")
ONVIF_DISCOVERY: bool = env_bool("ONVIF_DISCOVERY", "true", style="bool")
